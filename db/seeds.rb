@merchant_1 = Merchant.create!(name: "store_1")
@merchant_2 = Merchant.create!(name: "store_2")
@merchant_3 = Merchant.create!(name: "store_3")
@merchant_4 = Merchant.create!(name: "store_4")
@merchant_5 = Merchant.create!(name: "store_5")
@merchant_6 = Merchant.create!(name: "store_6")
...
@item_5 = @merchant_3.items.create!(name: "stapler", description: "Staples papers together", unit_price: 13)
@item_6 = @merchant_4.items.create!(name: "paper", description: "construction", unit_price: 29)
@item_7 = @merchant_5.items.create!(name: "calculator", description: "TI-84", unit_price: 84)
@item_8 = @merchant_6.items.create!(name: "paperclips", description: "24 Count", unit_price: 25)
...
@invoice_item_5 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_1.id, quantity: 5, unit_price: 10, status: "packaged")
@invoice_item_6 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_2.id, quantity: 6, unit_price: 10, status: "pending")
@invoice_item_7 = InvoiceItem.create!(invoice_id: @invoice_7.id, item_id: @item_3.id, quantity: 7, unit_price: 10, status: "shipped")
@invoice_item_8 = InvoiceItem.create!(invoice_id: @invoice_8.id, item_id: @item_4.id, quantity: 8, unit_price: 10, status: "packaged")
@invoice_item_9 = InvoiceItem.create!(invoice_id: @invoice_9.id, item_id: @item_1.id, quantity: 9, unit_price: 10, status: "pending")
@invoice_item_10 = InvoiceItem.create!(invoice_id: @invoice_10.id, item_id: @item_2.id, quantity: 10, unit_price: 10, status: "shipped")
@invoice_item_11 = InvoiceItem.create!(invoice_id: @invoice_11.id, item_id: @item_3.id, quantity: 11, unit_price: 10, status: "packaged")
@invoice_item_12 = InvoiceItem.create!(invoice_id: @invoice_12.id, item_id: @item_4.id, quantity: 12, unit_price: 10, status: "pending")
@invoice_item_12 = InvoiceItem.create!(invoice_id: @invoice_12.id, item_id: @item_3.id, quantity: 12, unit_price: 10, status: "pending")
